...
import com.cts.ihttp.cache.converter.SerializableDiskConverter
import com.cts.ihttp.cache.model.CacheMode
import com.cts.ihttp.cookie.CookieManger
import com.cts.ihttp.https.HttpsUtils
import com.cts.ihttp.interceptor.HttpLoggingInterceptor
import com.cts.ihttp.model.HttpHeaders
import com.cts.ihttp.request.*
...
class IHttp {
    ...
    private var mCacheMaxSize: Long = 0                                 //缓存大小

    private var mBaseUrl: String? = null                                //全局BaseUrl
//    private var commonRequest: CommonRequest? = null                    //request
    ...
    private var iCacheBuilder: ICache.Builder                           //RxCache请求的Builder
    ...
    constructor() {
        ...
        iCacheBuilder = ICache.Builder().init(sContext)
                .diskConverter(SerializableDiskConverter()) //目前只支持Serializable和Gson缓存其它可以扩展
    }
